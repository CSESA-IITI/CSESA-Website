...
// const mockRemoveContributorsOptimistic = vi.mocked(
//   removeContributorsOptimistic
// );
...
//     year: "2024",
//     bio: "Test bio",
//     image_url: "https://example.com/associate1.jpg",
//     skills: [{ name: "React" }],
//     github_link: "",
//     linkedin_link: "",
//   };
...
//         "Project for testing integration flow"
//       );
//       await user.type(
//         screen.getByLabelText(/tech stack/i),
//         "Django, React, PostgreSQL"
//       );
//       await user.type(
//         screen.getByLabelText(/github link/i),
//         "https://github.com/test/integration-project"
//       );

//       // Verify "Add myself as contributor" is checked by default
//       const addSelfCheckbox = screen.getByLabelText(
//         /add myself as contributor/i
//       );
...
//         message:
//           "Integration Test Project has been created and you have been added as a contributor.",
//         duration: 5000,
//       });
//     });
...
//       await user.type(
//         screen.getByLabelText(/project name/i),
//         "No Contributors Project"
//       );
//       await user.type(
//         screen.getByLabelText(/description/i),
//         "Project created without initial contributors"
//       );
//       await user.type(screen.getByLabelText(/tech stack/i), "Python, FastAPI");
//       await user.type(
//         screen.getByLabelText(/github link/i),
//         "https://github.com/test/no-contributors"
//       );
...
//       mockRemoveContributorsOptimistic.mockImplementation(
//         async (projectId, userIds, currentContributors, onUpdate, onError) => {
//           const updatedContributors = currentContributors.filter(
//             (c) => !userIds.includes(parseInt(c.id))
//           );
//           onUpdate(updatedContributors);
//         }
//       );
...
//         const contributorCard = button.closest(
//           '[data-testid*="contributor-card"]'
//         );
//         return (
//           contributorCard &&
//           within(contributorCard).queryByText("Associate One")
//         );
//       });
...
//         title: "Contributors Added Successfully",
//         message:
//           "Added 4 contributors: Test Coordinator, Associate One, Associate Two, Associate Three",
//         duration: 5000,
//       });
//     });
//   });
...
//             message:
//               "You do not have permission to manage contributors for this project",
//             statusCode: 403,
//           } as any);
//         }
//       );
...
//       await waitFor(() => {
//         expect(
//           screen.getByText("Failed to fetch available contributors")
//         ).toBeInTheDocument();
...
//       await waitFor(
//         () => {
//           expect(onContributorsUpdate).toHaveBeenCalledWith([mockPresident]);
//         },
//         { timeout: 200 }
//       );
...
//       expect(
//         screen.getByText("Loading available contributors...")
//       ).toBeInTheDocument();
...
//       expect(
//         screen.queryByText("Loading available contributors...")
