              ...
              <div className="text-center">
                ...
                <div className="space-y-3">
                    ...
                    {user.domain && (
                      <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-cyan-600/20 border border-cyan-400/30 rounded-full">
                        <span className="text-cyan-300 font-medium text-sm">
                          {user.domain.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-1 text-center">
                    ...
                    {user.year && (
                      <p className="text-gray-400 text-sm">Class of {user.year}</p>
                    )}
                    {user.bio && (
                      <p className="text-gray-300 text-sm mt-3 italic max-w-xs mx-auto">"{user.bio}"</p>
                    )}
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full p-3 rounded-lg bg-gray-800/50 backdrop-blur-sm text-white border border-blue-400/30 focus:border-blue-400 focus:ring-1 focus:ring-blue-400/50 outline-none transition-all duration-300 resize-vertical ${
                      !isEditing ? 'opacity-60 cursor-not-allowed' : 'hover:border-blue-400/50'
                    }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-white mb-2 font-medium">
                      Role <span className="text-gray-400 text-sm">(Set by President)</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-white mb-2 font-medium">
                      Domain <span className="text-gray-400 text-sm">(Set by President)</span>
                    </label>
                    <input
                      type="text"
                      value={user?.domain?.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase()) || 'Not assigned'}
                      disabled={true}
                      className="w-full p-3 rounded-lg bg-gray-800/30 backdrop-blur-sm text-gray-400 border border-gray-600/30 cursor-not-allowed"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-white mb-2 font-medium">
                      Graduation Year <span className="text-gray-400 text-sm">(Set by President)</span>
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-white mb-2 font-medium">
                    Email <span className="text-gray-400 text-sm">(Read-only)</span>
                  </label>
                  <input
                    type="email"
                    id="email"
                  ...
                  {isEditing && (
                    <div className="space-y-3">
                      ...
                      {availableSkills.length > 0 && (
                        <div>
                          <p className="text-gray-400 text-sm mb-2">Suggested skills:</p>
                          <div className="flex flex-wrap gap-2">
                            {availableSkills
