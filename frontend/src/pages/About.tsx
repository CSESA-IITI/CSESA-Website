...
// import { AdvancedLineReveal } from "../components/AdvancedLineReveal";
...
const About: React.FC = () => {
  ...
  const clipPath = useTransform(
    scrollYProgress,
    [0.2, 0.8], // Animate between 20% and 80% of the scroll progress
    ...
    () => [
      {
        ...
        title: "Foundation",
        description:
          "CSESA was founded with a vision to create a supportive tech community.",
        icon: "🚀",
      ...
      },
      {
        ...
        description:
          "Organized our inaugural hackathon 'CodeStorm', establishing CSESA as a major event organizer.",
        icon: "⚡",
        tech: "CodeStorm v1.0",
      },
      {
        ...
        description:
          "Formed strategic partnerships, providing students with internship and job opportunities.",
        icon: "🤝",
      ...
      },
      {
        ...
        description:
          "Successfully transitioned to virtual events, reaching a global audience.",
        icon: "🌐",
      ...
      },
      {
        ...
        description:
          "Launched our Innovation Lab for access to cutting-edge technology and mentorship.",
        icon: "🔬",
        tech: "Lab OS",
      },
      {
        ...
        title: "AI Initiative",
        description:
          "Introduced AI/ML workshops and projects, keeping pace with technological advancements.",
        icon: "🤖",
        tech: "Neural Network",
      },
      {
        ...
        title: "Global Reach",
        description:
          "Expanded our community internationally, fostering global collaboration.",
        icon: "🌍",
        tech: "Global Mesh",
      },
    ],
    ...
    () => [
      {
        title: "Innovation",
        description:
          "We foster creativity, pushing the boundaries of what's possible in technology.",
        icon: "💡",
      ...
      },
      {
        title: "Collaboration",
        description:
          "We believe in teamwork and create opportunities for students to learn from each other.",
        icon: "🤝",
      ...
      },
      {
        title: "Excellence",
        description:
          "We strive for the highest standards in our events, projects, and community initiatives.",
        icon: "⭐",
      ...
      },
      {
        title: "Inclusivity",
        description:
          "We welcome students from all backgrounds, creating an environment where everyone can grow.",
        icon: "🌈",
        ...
        >
          <GlowCard className="p-12 group" glowColor="blue">
            ...
            <p className="text-xl text-slate-300 leading-relaxed max-w-4xl mx-auto font-light alegreya-sans-sc-regular text-center">
              ...
              where computer science students can learn, grow, and innovate
              together. We bridge the gap between{" "}
              <span className="text-blue-400 font-medium">
                academic learning
              </span>{" "}
              and{" "}
              ...
              >
                ...
                >
                  <motion.div whileHover={{ scale: 1.1 }} className="relative">
                    <div
                      className={`text-4xl md:text-6xl font-black mb-3 ${stat.color} relative`}
                    >
